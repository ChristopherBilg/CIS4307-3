...
public class AsyncDeregister extends AsyncTask<Void, Void, Void> {
    ...
    public AsyncDeregister(String username, String hostname, int port, String uuid) {
    ...
    protected Void doInBackground(Void... params) {
        try {
            deregisterUsernameWithServer(this.username, this.hostname, this.port, this.uuid);
        } catch (IOException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public void deregisterUsernameWithServer(String username, String hostname, int port, String uuid) throws IOException {
        DatagramSocket socket = new DatagramSocket();
        InetAddress address = InetAddress.getByName(hostname);

        String registrationString = "{\"header\":{\"username\":\"" + username + "\",\"uuid\":\"" + uuid + "\",\"timestamp\":\"{}\",\"type\":\"deregister\"},\"body\":{}}";
